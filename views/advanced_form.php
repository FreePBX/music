...
<script>var display_mode = 'advanced';var files = <?php echo json_encode($files, JSON_THROW_ON_ERROR)?>; var supportedRegExp = "<?php echo implode("|",array_keys($supported['in']))?>"; var supportedHTML5 = "<?php echo implode(",",FreePBX::Media()->getSupportedHTML5Formats())?>"</script>
